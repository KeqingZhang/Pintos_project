...
tid_t process_execute(const char *proc_cmd)
{
  ...
  proc_cmd_copy1 = malloc(strlen(proc_cmd) + 1);
  proc_cmd_copy2 = malloc(strlen(proc_cmd) + 1);
...
static void start_process(void *proc_cmd_)
{
  ...
  char *proc_cmd_copy = malloc(strlen(proc_cmd_) + 1);
